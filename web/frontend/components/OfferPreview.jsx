...
export function OfferPreview(props) {
			...
			fetch(`/api/merchant/offer_settings`, {
				...
				.then((data) => {
					...
					if(!props.offer.advanced_placement_setting) {
						props.updateNestedAttributeOfOffer(offerSettings?.product_page_dom_selector || "[class*='description']", "advanced_placement_setting",  "custom_product_page_dom_selector")
						props.updateNestedAttributeOfOffer(offerSettings?.product_page_dom_action ||'after', "advanced_placement_setting",  "custom_product_page_dom_action")
						props.updateNestedAttributeOfOffer(offerSettings?.cart_page_dom_selector || "form[action^='/cart']", "advanced_placement_setting",  "custom_cart_page_dom_selector")
						props.updateNestedAttributeOfOffer(offerSettings?.cart_page_dom_action || 'prepend', "advanced_placement_setting",  "custom_cart_page_dom_action")
						props.updateNestedAttributeOfOffer(offerSettings?.ajax_dom_selector || ".ajaxcart__row:first", "advanced_placement_setting",  "custom_ajax_dom_selector")
						props.updateNestedAttributeOfOffer(offerSettings?.ajax_dom_action || 'prepend', "advanced_placement_setting",  "custom_ajax_dom_action")
					}
				})
				.catch((error) => {
	...
	}, [props.offer.css_options, props.updatePreviousAppOffer]);
