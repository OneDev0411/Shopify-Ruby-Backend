...
export default function Compact(props) {
	...
	const template = `<div id="nudge-offer-{{ id }}" style="-webkit-background-clip: padding-box; background-color: {{ css_options.main.backgroundColor }}; color: {{ css_options.main.color}}; {{#mainMarginTop }} margin-top: {{css_options.main.marginTop}}; {{/mainMarginTop}} {{#mainMarginBottom }} margin-bottom: {{css_options.main.marginBottom}}; {{/mainMarginBottom}} {{#mainBorderWidth}} border: {{css_options.main.borderWidth}}px {{css_options.main.borderColor}} {{css_options.main.borderStyle}}; {{/mainBorderWidth}} {{#mainBorderRadius}} border-radius: {{css_options.main.borderRadius}}px; {{/mainBorderRadius}} {{ #mobileViewWidth }} width: 320px {{/ mobileViewWidth}}" class="nudge-offer custom with-image  multi compact" data-offerid="163416">
	        ...
	        <div class="icu-offer-title"style="text-align: center; {{#textFontWeight}} font-weight: {{css_options.text.fontWeight}}; {{/textFontWeight}}{{#textFontFamily}} font-family: {{css_options.text.fontFamily}}; {{/textFontFamily}} {{#textFontSize}} font-size: {{css_options.text.fontSize}}; {{/textFontSize}} color: {{ css_options.text.color}};">
	            <strong>{{{ text }}}</strong>
	        </div>
	          ...
	          <div class="nudge-wrapper" style="text-align: center">
	            ...
	            <div action="/cart/add" class="variants" id="product-actions-{{ id }}" method="post">
	              ...
	              {{#show_variant_price}}
							  ...
							  {{/recharge_subscription_id}}
	              {{#show_spinner}}
							  <button type="submit" name="add" class="bttn product-price" style="background-color: {{ css_options.button.backgroundColor }}; color: {{ css_options.button.color  }}; {{#buttonBorderRadius}} border-radius: {{css_options.button.borderRadius}}px; {{/buttonBorderRadius}} {{#buttonFontWeight}} font-weight: {{css_options.button.fontWeight}}; {{/buttonFontWeight}} {{#buttonFontFamily}} font-family: {{css_options.button.fontFamily}}; {{/buttonFontFamily}} {{#button.fontSize}} {{css_options.button.fontSize}}; {{/button.fontSize}} {{#buttonBorderWidth}} border: {{css_options.button.borderWidth}}px {{css_options.button.borderColor}} {{css_options.button.borderStyle}}; {{/buttonBorderWidth}}">{{{ cta }}}</button>
							  {{/show_spinner}}
							  {{^show_spinner}}
							  <input type="submit" name="add" class="bttn product-price" value="{{{ cta }}}" style="background-color: {{ css_options.button.backgroundColor }}; color: {{ css_options.button.color  }}; {{#buttonBorderRadius}} border-radius: {{css_options.button.borderRadius}}px; {{/buttonBorderRadius}} {{#buttonFontWeight}} font-weight: {{css_options.button.fontWeight}}; {{/buttonFontWeight}} {{#buttonFontFamily}} font-family: {{css_options.button.fontFamily}}; {{/buttonFontFamily}} {{#buttonFontSize}} font-size: {{css_options.button.fontSize}}; {{/buttonFontSize}} {{#buttonBorderWidth}} border: {{css_options.button.borderWidth}}px {{css_options.button.borderColor}} {{css_options.button.borderStyle}}; {{/buttonBorderWidth}}" ></input>
							  {{/show_spinner}}
	            </div>
	        	</div>
			      {{/offerable_product_details}}
