const customFields = (offer, offerable_product) => {
  ...
  if (offer.custom_field_name && offer.custom_field_required) {
    let input_1 = document.getElementById(`custom-field-compact-first-${offerable_product}`);
  ...
  if (offer.custom_field_2_name && offer.custom_field_2_required) {
    let input_2 = document.getElementById(`custom-field-compact-first-${offerable_product}`);
  ...
  if (offer.custom_field_3_name && offer.custom_field_3_required) {
    let input_3 = document.getElementById(`custom-field-compact-first-${offerable_product}`);
